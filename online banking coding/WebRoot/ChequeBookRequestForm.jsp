...
<span id="clock"></span>
    ...
    <center><h3><form action="./chequeIssueAction.do">
			 <input type="text" name="accountno" value="<%=(String)session.getAttribute("accountno") %>"/>
			
			From number : <input type="text" name="fromnumber"/>
			
			 <input type="text" name="loginname" value="<%=(String)session.getAttribute("user") %>"/>
			To Number : <input type="text" name="toNumber"/>
			
		 <input type="text" name="requestid" value="<%=request.getParameter("requestid") %>"/>
