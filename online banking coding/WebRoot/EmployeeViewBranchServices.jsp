...
<style type="text/css">
<!--
.style4 {color: #D4F101; font-weight: bold; }
-->
</style>
</head>
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <center><h3>View Branch Services</h3></center>
         <form action="EmployeeViewBranchServices.jsp" method="post">
         <table bgcolor="#9AE4A9"> 
           <tr>
            ...
            <tr><td></td><td><input type="submit" name="send" value="Search"/></td></tr></table>
                  ...
                  <td><div align="center"><strong>Service Description</strong></div></td>
                    ...
                    BankServicesMasterForm aform=(BankServicesMasterForm)aenumeration1.nextElement();
                                         %>
                    <tr bgcolor="#004B10"><td><span class="style4"><%=aform.getBranchdesc() %></span></td><td><span class="style4"><%=aform.getServiceName() %></span></td><td><span class="style4"><%=aform.getServiceDesc() %></span></td></tr>
            <%} %></table>
  <%} %>                  
