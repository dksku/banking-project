...
<span id="clock"></span>
    ...
    <center><h3>Funds Transfer</h3></center>
    <form action="fundsTransferAction.do">
		 <table bgcolor="#66B075">
		   <tr><td><input name="loginid" type="hidden" class="style1" value="<%=(String)session.getAttribute("user") %>"/>
</td>
		   </tr><tr><td><strong>			
			Amount :</strong></td>
		   <td> <input type="text" name="amount"/></td></tr>
		<tr><td><input name="fromAccountno" type="hidden" value="<%=(String)session.getAttribute("accountno") %>" readonly/></td>
		</tr>
			<tr><td><strong>To Accountno :</strong></td>
			<td> <input type="text" name="toAccountno"/><html:errors property="toAccountno"/><br/></td></tr>
			<tr><td></td>
			<td><input type="submit" name="send" value="Transfer"/>		</td></tr>
		</table>
    </form>
