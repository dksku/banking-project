...
function mmLoadMenus() {
  ...
  mm_menu_1224101012_0.addMenuItem("Register Customers","location='Registerform.jsp'");
  mm_menu_1224101012_0.addMenuItem("ViewCustomerAccounts","location='ViewCustomerBalance.jsp'");
   mm_menu_1224101012_0.addMenuItem("Transaction","location='EmployeeTransactionMaster.jsp'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
  mm_menu_1224101649_0.addMenuItem("ChequeBook Requests","location='viewChequeBookRequest.do'"); 
 ...
 // mm_menu_1224101903_0.addMenuItem("View Dealer Orders","location='UpdateDealerOrder.jsp'");-->
   mm_menu_1224101903_0.addMenuItem("View ChequeBook Requests","location='viewChequeBookRequest.do'");
  ...
  mm_menu_1224122939_0.addMenuItem("Funds Transfer","location='EmployeeViewFundTransferBalance.jsp'");
  mm_menu_1224122939_0.addMenuItem("View Transactions","location='EmployeeSerchBalance.jsp'");
...
<a href="#"  class="style1" name="link7" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1224101012_0,0,25,null,'link7')" onMouseOut="MM_startTimeout();" >Customers     </a>&nbsp;&nbsp;|
<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >Cheque</a>&nbsp;&nbsp;|
...
<a href="#" name="link8" id="link8" class="style1" onMouseOver="MM_showMenu(window.mm_menu_1224122939_0,0,25,null,'link8')" onMouseOut="MM_startTimeout();">Reports</a>&nbsp;&nbsp;|
