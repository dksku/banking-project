...
function mmLoadMenus() {
  ...
  mm_menu_1224101012_0.addMenuItem("View Branches","location='viewBranchAction.do'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
  mm_menu_1224101649_0.addMenuItem("Register Services","location='accounttypeservices.do'"); 
  mm_menu_1224101649_0.addMenuItem("View Services","location='viewServiceAction.do'"); 
   ...
   mm_menu_1224101649_0.addMenuItem("View Services","location='ViewBranchServices.jsp'");
  ...
  mm_menu_1224101802_0.addMenuItem("View Employees","location='viewEmployeeAction.do'");
 ...
 // mm_menu_1224101903_0.addMenuItem("View Dealer Orders","location='UpdateDealerOrder.jsp'");-->
  ...
  mm_menu_1224122939_0.addMenuItem("View Customers","location='SerchBalance.jsp'");
  mm_menu_1224122939_0.addMenuItem("ViewCustomerTransactions","location='TransactionSerchBalance.jsp'");
 mm_menu_1224122939_0.addMenuItem("ViewCustomerLockedAccount","location='ViewCustomerAccountLocked.jsp'");
...
-->
	...
	<body>
		...
		<a href="#" name="link8" id="link8" class="style1"
			...
			onMouseOut="MM_startTimeout();">Reports</a>&nbsp;&nbsp;|
