...
<span id="clock"></span>
    ...
    <center><h3>Customer Details</h3></center>
          ...
          <form action="EmployeeViewFundTransferBalance.jsp" name="register">
...
<tr><td></td><td>   <input type="submit" name="send" value="Find"/></td></tr>
 ...
 CoreList acorelist =new FundsTransferDAO().viewFundsTransfer(formdate,todate); 
     ...
     %>
     <tr bgcolor="#0C561B"><td><span class="style1"><%=amodel.getLoginid()%></span></td><td><span class="style1"><%=amodel.getFromAccountno() %></span></td>
     <td><span class="style1"><%=amodel.getToAccountno() %></span></td>
    
     <td><span class="style1"><%=amodel.getAmount() %></span></td>
     </tr><%} }%></table>
