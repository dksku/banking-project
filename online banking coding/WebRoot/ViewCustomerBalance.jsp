...
<span id="clock"></span>
    ...
    <center>
    <form action="ViewCustomerBalance.jsp">
   <table bgcolor="#95DFA4">
     <tr><td><strong>Account no</strong></td>
     <td><input type="text" name="accountno">   </td></tr>
<tr><td></td>
<td>   <input type="submit" name="send" value="Find"/></td></tr>
</table>
    </form>
    <%
    ...
    Profile aprofile =new BankAccountDAO().viewAccountNos(accountno); 
     %>
