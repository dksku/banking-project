...
function mmLoadMenus() {
  ...
  mm_menu_1224101012_0.addMenuItem("View Branches","location='customerviewBranchAction.do'");
   // mm_menu_1224101012_0.addMenuItem("Register Account Types","location='AccountTypeMaster.jsp'");
   mm_menu_1224101012_0.addMenuItem("View Account Types","location='ViewCustomerBranchAccountTypes.jsp'");
   mm_menu_1224101012_0.addMenuItem("Services Types","location='CustomerViewBranchServices.jsp'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
  mm_menu_1224101649_0.addMenuItem("View Profile","location='customerProfile.do'"); 
 //  mm_menu_1224101649_0.addMenuItem("View Services","location='viewServiceAction.do'"); 
  ...
  mm_menu_1224101802_0.addMenuItem("Account Balance","location='CustomerAccountBalance.jsp'");
  mm_menu_1224101802_0.addMenuItem("Funds Transfer","location='FundsTransfer.jsp'");
 ...
 // mm_menu_1224101903_0.addMenuItem("View Dealer Orders","location='UpdateDealerOrder.jsp'");-->
   mm_menu_1224101903_0.addMenuItem("Cheque Book Request","location='ChequeBookRequestForm1.jsp'");
   mm_menu_1224101903_0.addMenuItem("view Cheque Books","location='viewCustomerChequeBookRequest.do'");
   mm_menu_1224101903_0.addMenuItem("StopPaymentRequests","location='StoppaymentMaster.jsp'");
  ...
  mm_menu_1224122939_0.addMenuItem("Add Assets","location='AssetTypeMaster.jsp?submit=viewDetails'");
...
<a href="#"  class="style1" name="link7" id="link1" onMouseOver="MM_showMenu(window.mm_menu_1224101012_0,0,25,null,'link7')" onMouseOut="MM_startTimeout();" >Branches     </a>&nbsp;&nbsp;|
<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >Profile</a>&nbsp;&nbsp;|
 <a href="#" class="style1" name="link5" id="link3" onMouseOver="MM_showMenu(window.mm_menu_1224101802_0,0,25,null,'link5')" onMouseOut="MM_startTimeout();">Accounts</a>&nbsp;&nbsp;|
<%--<a href="ViewQueries.jsp" class="style1" >Queries</a>&nbsp;&nbsp;|&nbsp;&nbsp;--%>
<a href="#" name="link4" id="link4" class="style1" onMouseOver="MM_showMenu(window.mm_menu_1224101903_0,0,25,null,'link4')" onMouseOut="MM_startTimeout();">Cheque</a>&nbsp;&nbsp;|
