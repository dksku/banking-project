...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <center><h3>View Branch Account Types </h3></center>
         <form action="ViewBranchAccountTypes.jsp" method="post">
         <table> <tr>
...
<th>Cheque Book</th>           
 ...
 %>
 <tr bgcolor="#0C561B">
 <td><input name="TypeId" type=checkbox value="<%=form.getAccTypeId()%>"></td>
 <td><span class="style3"><%=form.getTypeName() %></span></td>
 <td><span class="style3"><%=form.getAbbr()%></span></td>
 <td><span class="style3"><%=form.getMinOpenBal()%></span></td>
 <td><span class="style3"><%=form.getMaxOpenBal()%></span></td>
 <td><span class="style3"><%=form.getIntrestApplicable()%></span></td>
 <td><span class="style3"><%=form.getDescription()%></span></td>
 <td><span class="style3"><%=form.getMinBalToBeMaintain()%></span></td>
 <td><span class="style3"><%=form.getCheckbookFacilityBit()%></span></td>
 <%}%>
 </table>
