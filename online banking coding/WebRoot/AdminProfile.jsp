...
<%@page import="com.dts.SBIBanking.dao.*"%>
							...
							<td height="314" align="center">
								...
								<table>
									...
									<%
										...
										String branchname = new BranchEmmployeeDAO().getBranchname(aprofile
												.getLoginID());
										;
									%>
									<tr bgcolor="#0C561B">
										...
										<td>
											<div align="center">
												<strong><a
													href="AdminUpdateProfile.jsp?loginid=<%=aprofile.getLoginID()%>"
													class="style1"><%=aprofile.getLoginID()%></a>
												</strong>
											</div>
										</td>
										<td>
											<div align="center">
												<strong><span class="style1"><%=aprofile.getFirstname()%></span>
												</strong>
											</div>
										</td>
										<td>
											<div align="center">
												<strong><span class="style1"><%=aprofile.getLastName()%></span>
												</strong>
											</div>
										</td>
										<td>
											<div align="center">
												<strong><span class="style1"><%=aprofile.getBirthDate1()%></span>
												</strong>
											</div>
										</td>
										<td>
											<div align="center">
												<strong><span class="style1"><%=aprofile.getCity()%></span>
												</strong>
											</div>
										</td>
										<td>
											<div align="center">
												<strong><span class="style1"><%=aprofile.getState()%></span>
												</strong>
											</div>
										</td>
										<td>
											<div align="center">
												<strong><span class="style1"><%=aprofile.getCountry()%></span>
												</strong>
											</div>
										</td>
									</tr>
