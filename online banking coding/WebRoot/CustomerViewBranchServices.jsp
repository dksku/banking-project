...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<font color=red><b><%=request.getParameter("status") %></b></font><%} %></td>
	</tr>
    ...
    <center><h3>View Branch Services</h3></center>
         <form action="CustomerViewBranchServices.jsp" method="post">
         <table bgcolor="#61AB70"> 
           <tr>
            ...
            <tr><td></td><td><input type="submit" name="send" value="Search"/></td></tr></table>
                  ...
                  %>
                  <table border="1"><tr bgcolor="#D4F101"><td><div align="center"><strong>Branch Address</strong></div></td>
                  <td><div align="center"><strong>Service Name</strong></div></td>
                  <td><div align="center"><strong>Service Description</strong></div></td>
                  </tr>      
                             <%  while(aenumeration1.hasMoreElements())
                    {
                    BankServicesMasterForm aform=(BankServicesMasterForm)aenumeration1.nextElement();
                                         %>
                    <tr bgcolor="#0C561B"><td><span class="style1"><%=aform.getBranchdesc() %></span></td>
                    <td><span class="style1"><%=aform.getServiceName() %></span></td>
                    <td><span class="style1"><%=aform.getServiceDesc() %></span></td>
                    </tr>
            <%} %></table>
  <%} %>                  
